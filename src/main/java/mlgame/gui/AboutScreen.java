...
public class AboutScreen extends ParentedScreen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        Text text = Text.of("""
            ...
            The neural network consists of 3 layers, 13 input neurons, 96 hidden neurons, and 1 output neuron
            ...
            A population of 1000 brains are tested simultaneously in 10 different game instances (seeds)
            
            The seeds are rotated every 10 generations to avoid overfitting
            
            The most performing brains are selected to create the next generation, keeping the best ones (elitism), and mutating the rest while resetting the worst ones to allow for different genetics paths
            """);
